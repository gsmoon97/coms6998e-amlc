...
PEAK_COMPUTE = 30300  # GFLOPs/sec (FP32 with TF32 Tensor Core)
PEAK_BANDWIDTH = 300  # GB/sec
RIDGE_POINT = PEAK_COMPUTE / PEAK_BANDWIDTH

# The 6 files generated for the L4 experiments
csv_files = [
    'resnet50_train_l4.csv', 'resnet50_eval_l4.csv',
    'vgg16_train_l4.csv', 'vgg16_eval_l4.csv',
    'vit_train_l4.csv', 'vit_eval_l4.csv'
]

# Map filenames to pretty plot labels for the legend
label_map = {
    'resnet50_train_l4.csv': 'ResNet-50 (Train)',
    'resnet50_eval_l4.csv': 'ResNet-50 (Eval)',
    'vgg16_train_l4.csv': 'VGG-16 (Train)',
    'vgg16_eval_l4.csv': 'VGG-16 (Eval)',
    'vit_train_l4.csv': 'ViT-B-16 (Train)',
    'vit_eval_l4.csv': 'ViT-B-16 (Eval)'
}
...
if models_ai and any(perf > 0 for perf in models_perf.values()):
    ...
    ax.plot(ai_vals, perf_vals, color='black', linewidth=2, label='L4 Theoretical Roofline')
    ...
    ax.set_title('Empirical Roofline Model: Architectures on NVIDIA L4', fontsize=14)
    ...
    plt.savefig('l4_roofline_empirical.png', dpi=300, bbox_inches='tight')
    print("Roofline plot saved as 'l4_roofline_empirical.png'")
else:
